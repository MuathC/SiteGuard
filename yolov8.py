...
COCO_CLASSES =  [
    ...
    "Person", "Safety Cone", "Safty Vest", "Machinery", "Vehicle"
]


COCO_CLASSES2 =  [
    "COCO_CLASSES2", "COCO_CLASSES22", "NO-COCO_CLASSES2", "NO-COCO_CLASSES22", "NO-COCO_CLASSES2 Vest",
    "COCO_CLASSES2221", "COCO_CLASSES2 Cone", "COCO_CLASSES2 Vest", "COCO_CLASSES22123", "COCO_CLASSES2234"
]
...
###################################################################################################
    ...
    def postprocess_model1(self, output):
        """
        Performs post-processing on the YOLOv8 model's output to extract bounding boxes, scores, and class IDs.
        ...
        detections = [{
            'bbox': valid_boxes[i].astype(int).tolist(),
            'class_id': int(valid_class_ids[i]),
            'class': COCO_CLASSES2[int(valid_class_ids[i])],
            'score': valid_scores[i]
        } for i in range(len(valid_indices))]
